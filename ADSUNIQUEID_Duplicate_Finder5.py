...
def xmlcompare(Elem_Type,root,Resultfile2,str2):
    ...
    for i in range (0,Total_ElementCount):
        ...
        for k in range(0,Child_elem_count):
            ...
            #print elem_check[1]
            if not ((elem_check[1] == ('TicketingArrangement' )) or (elem_check[1] ==('AccountingDetails'))or (elem_check[1] == ('Passenger'))) : 
               #print elem_check[1] 
...
filename = raw_input("Enter the ADN XML Path : (ex: D:\XML_Compare\TestData\ADN) : ")
